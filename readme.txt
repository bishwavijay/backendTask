...
http://127.0.0.1:8000/signup/?user_id=vijay&pas=123

login by sending parameters user_id and password.
http://127.0.0.1:8000/login/?user_id=vijay&pas=123
in response you will get random number only 5 times a minute,
